 ...
 */
export function initTracing(serviceName, environment = 'development', collectorUrl = '/api/v1/traces', additionalAttributes = {}) {
 ...
 */
export function traceComponent(Component, name) {
    ...
    const TracedComponent = (props) => {
        const result = withSpan(spanName, () => React.createElement(Component, props), { component: displayName });
        return result;
    };
 ...
 */
export function useTraceFunction(name, attributes = {}) {
    return (fn) => {
