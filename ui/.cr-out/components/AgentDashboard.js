...
export default function AgentDashboard() {
    ...
    const renderDesktopView = () => {
        ...
        const handlePageChange = (pageNumber) => {
            ...
            (_a = document.getElementById('agents-grid')) === null || _a === void 0 ? void 0 : _a.scrollIntoView({ behavior: 'smooth' });
        };
