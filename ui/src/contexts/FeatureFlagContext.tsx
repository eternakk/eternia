...
interface FeatureFlagProviderProps {
    ...
    initialFlags?: Partial<Record<FeatureFlagName, FeatureFlag>>;
...
export const FeatureFlagProvider: React.FC<FeatureFlagProviderProps> = ({
                                                                            children,
                                                                            initialFlags = {} as Record<FeatureFlagName, FeatureFlag>,
                                                                            flagsUrl,
                                                                        }) => {
    const [flags, setFlags] = useState<Record<FeatureFlagName, FeatureFlag>>(initialFlags as Record<FeatureFlagName, FeatureFlag>);
        ...
        if (flagsUrl) {
            const fetchFlags = async () => {
                try {
                    ...
                    setFlags(data as Record<FeatureFlagName, FeatureFlag>);
                } catch (error) {
    ...
    const updateFeatureFlag = (name: FeatureFlagName, updates: Partial<FeatureFlag>) => {
        setFlags(prevFlags => {
            ...
            return updatedFlags as Record<FeatureFlagName, FeatureFlag>;
        });
    };
